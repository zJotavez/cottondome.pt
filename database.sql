...
-- applications, related_products, benefits, work_process are stored as JSON arrays
INSERT INTO `service_pages` (`service_id`, `page_title`, `impact_phrase`, `full_description`, `applications`, `related_products`, `benefits`, `work_process`, `final_cta_title`, `final_cta_text`, `seo_title`, `seo_description`, `seo_keywords`) VALUES
